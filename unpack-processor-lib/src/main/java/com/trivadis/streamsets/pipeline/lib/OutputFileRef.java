package com.trivadis.streamsets.pipeline.lib;
...
public class OutputFileRef extends FileRef {
    ...
    @Override
    public <T extends AutoCloseable> T createInputStream(ProtoConfigurableEntity.Context context, Class<T> aClass) throws IOException {
